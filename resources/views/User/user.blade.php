                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" data-id="">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="input-name" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">メールアドレス</span>
                            </div>
                            <input type="text" class="form-control" id="input-email" aria-label="MailAddress" aria-describedby="basic-addon2">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="input-admin">
